                ...
                <div class="panel panel-login filter">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            @endif
                            <div class="col-md-12">
                                <form role="form" enctype="multipart/form-data" method="post" action="{{ url('/admin/edit-adult_secondservice/'.$adultDetails->id) }}" name="adult_service" novalidate="novalidate">
                                    {{ csrf_field() }}
                                    <div class="col-md-4">
                                ...
                                <div class="modal-footer">
                                    <a href="{{ url('admin/view-adult_secondservice/'.$adultDetails->id) }}" class="btn btn-danger">
