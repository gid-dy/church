                ...
                <div class="panel panel-login filter">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            @endif
                            <div class="col-md-12">
                                <form  role="form" enctype="multipart/form-data" method="post" action="{{ url('/admin/edit-children_firstservice/'.$childrenDetails->id) }}" name="edit_children_service"s novalidate="novalidate">
                                    {{ csrf_field() }}
                                    <div class="col-md-4">
